# Local Development
Pteranodon is now powered by React, Typescript, and Tailwindcss using webpack at its core to generate compiled assets.
Release versions of Pteranodon will include pre-compiled, minified, and hashed assets ready-to-go.
...
The command above will download all of the dependencies necessary to get Pteranodon assets building. After that, its as
...
the asset URLs used in Pteranodon.

#### Development Environment
If you're using the [`Pteranodon/development`](https://github.com/Pteranodon/development) environments, which are
