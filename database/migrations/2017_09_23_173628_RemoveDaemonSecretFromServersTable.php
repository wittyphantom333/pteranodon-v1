...
use Pteranodon\Contracts\Repository\DaemonKeyRepositoryInterface;
    ...
    public function up()
    {
        ...
        $servers->each(function ($server) use (&$inserts) {
            $inserts[] = [
                ...
                'expires_at' => Carbon::now()->addMinutes(config('pteranodon.api.key_expire_time', 720))->toDateTimeString(),
