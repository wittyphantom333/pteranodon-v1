                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <div class="checkbox checkbox-primary no-margin-bottom">
                                    <input id="pForceOutgoingIp" name="force_outgoing_ip" type="checkbox" value="1" {{ \Pteranodon\Helpers\Utilities::checked('force_outgoing_ip', 0) }} />
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <textarea id="pDockerImages" name="docker_images" rows="4" placeholder="quay.io/Pteranodon/service" class="form-control">{{ old('docker_images') }}</textarea>
