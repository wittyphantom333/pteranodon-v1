...
@include('partials/admin.pteranodon.nav', ['activeTab' => 'appearance'])
...
@section('content-header')
    <h1>Pteranodon Appearance<small>Configure the theme for Pteranodon.</small></h1>
    <ol class="breadcrumb">
...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12">
            <form action="{{ route('admin.pteranodon.appearance') }}" method="POST">
            <div class="box box-info">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Theme Settings <small>The selection for Pteranodon's theme.</small></h3>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <select name="theme:admin" class="form-control">
                                        <option @if ($admin == 'pteranodon') selected @endif value="pteranodon">Default Theme</option>
                                    ...
                                    <p class="text-muted"><small>Determines the theme for Pteranodon's Admin UI.</small></p>
                                </div>
                            </div>
                            <div class="form-group col-md-4">
