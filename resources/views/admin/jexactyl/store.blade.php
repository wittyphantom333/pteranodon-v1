...
@include('partials/admin.pteranodon.nav', ['activeTab' => 'store'])
...
@section('content-header')
    <h1>Pteranodon Store<small>Configure the Pteranodon storefront.</small></h1>
    <ol class="breadcrumb">
...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12">
            <form action="{{ route('admin.pteranodon.store') }}" method="POST">
                <div class="box
                    @if($enabled == 'true')
                        box-success
                    @else
                ...
                ">
                    <div class="box-header with-border">
                        <i class="fa fa-shopping-cart"></i> <h3 class="box-title">Pteranodon Storefront <small>Configure whether certain options for the store are enabled.</small></h3>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <p class="text-muted"><small>The name of the currency used for Pteranodon.</small></p>
                            </div>
                        </div>
                    </div>
                </div>
